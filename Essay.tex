...
\begin{document}
	...
	\abstract{This paper explores the idea that guidelines, in regards to portraying suicide and/or depression in video games, could be a valuable resource and the reasons why. Taking information from multiple academic journals and grey literature from reputable sources, it draws analysis and insight from others findings. Overall it is determined that guidelines hold a potential value in the form of preventing negative effects that are sometimes caused when portraying suicide and/or depression. Additional value exists in the form of raised awareness and creating a new point of interest for discussions regarding this topic.}
