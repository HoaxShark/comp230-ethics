...
\begin{document}
	...
	\section{Will the industry listen?}
		...
		%There is minimal information to back this up in regards to the media guidelines. Collaboration between researchers and journalists limiting reporting of subway suicides was followed by a reduction in the number of suicides using that method\cite{etzersdorfer1998preventing}. 
	\section{Conclusion}
